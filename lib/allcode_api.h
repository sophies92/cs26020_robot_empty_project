...
// (c) Matrix TSL
#include <stdbool.h>
#include <stdarg.h> //For BTsprintf
#include <stdio.h>
#include <string.h>
...
/*sprintf component added by tof13 - Tomos Fearn*/
/**
 * Uses printf like syntax but prints out to Bluetooth serial.
 ...
 * @param .., any values referenced in format string
 */
void FA_BTprintf(char* format, ...);
